...
import (
	...
	"steamtoolbox/internal/config"
	"steamtoolbox/internal/httpclient"
	"steamtoolbox/internal/i18n"
	"steamtoolbox/internal/library"
	"steamtoolbox/internal/lua"
	"steamtoolbox/internal/manifest"
	"steamtoolbox/internal/models"
	"steamtoolbox/internal/patcher"
	"steamtoolbox/internal/search"
	"steamtoolbox/internal/steamtools"
)
...
func (a *App) runUnlockTask(appID string) {
	...
	if a.library != nil {
		...
		if parentID != "" && parentName != "" {
			// It's a DLC â€” merge under parent game
			parentIDInt := 0
			...
			// It's a main game â€” save normally
...
func (a *App) GetKernelSettings() models.KernelSettingsResponse {
	...
	if err != nil {
		// Key doesn't exist yet â€” return defaults (all false)
